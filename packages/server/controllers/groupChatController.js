...
// module.exports.updateSocketMessages = (req, res) => {
//   console.log("the routing to updateSocketMessages is working");
//   const newSocketMessageQuery = pool.query(
//     "INSERT INTO messages(sender_id, group_id, text) values ($1, $2, $3)",
//     [req.body.userId, req.body.currentGroup, req.body.mymessage]
//   );

//   const getSocketMessagesQuery = pool.query(
...
//     [req.body.currentGroup]
//   );
//   res.send(getSocketMessagesQuery.rows); // if this is null, check for that in the front end
//   //& tell the user they don't belong to any groups.
// };
